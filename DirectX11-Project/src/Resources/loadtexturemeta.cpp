...
void CreateTextureMeta(const std::filesystem::path& filepath)
{
	...
	file.write(defaultTextureMeta, std::strlen(defaultTextureMeta));
}
...
namespace Engine
{
	...
	{
		// Initialize default sampler description.
